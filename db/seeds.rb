...
20.times {Planet.create(name: Faker::TvShows::StarTrek.unique.location, distance_from_earth: Faker::Space.unique.distance_measurement, nearest_star: Faker::Space.star, planet_img: planet_images.sample)}

15.times {Scientist.create(name: Faker::FunnyName.name, field_of_study: Faker::Educator.subject)}

20.times {Mission.create(name: Faker::TvShows::Buffy.unique.episode, scientist_id: Scientist.all.sample.id, planet_id: Planet.all.sample.id)}